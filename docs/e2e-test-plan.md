...
| `e2e/journeys/03-words-capture-fill-ai-journey.spec.ts` | *      | `e2e-ci-w*@ord.test` | Words inbox → capture modal → Fill with AI → save → word visible in list                |
| `e2e/journeys/04-words-generate-manual-journey.spec.ts` | *      | `e2e-ci-w*@ord.test` | Words inbox → open word row → Generate with AI → manual sections appear in detail panel |
...
| Words capture modal + Fill with AI + save               | `03-words-capture-fill-ai-journey` | Stubbed AI fill-gaps on e2e backend profile           |
| Words list → detail panel → Generate with AI manual     | `04-words-generate-manual-journey` | Stubbed AI generate-manual on e2e backend profile     |
