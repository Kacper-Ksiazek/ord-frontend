		...
		<div class="max-w-6xl mx-auto">
						...
						<div class="space-y-6">
							...
							<div>
								...
								<div class="space-y-2">
									...
									>
									<Radio name="contact" bind:group={formData.preferredContact} value="sms"
										>SMS</Radio
									>
									<Radio
										name="contact"
							...
							<div class="space-y-3 pt-4 border-t dark:border-gray-700">
								...
								>
									I agree to the <button type="button" onclick={(e) => e.preventDefault()} class="text-blue-600 hover:underline"
					...
					{#if currentStep === 6}
						<div class="space-y-6">
							...
							<Alert color="blue">
								...
								{/snippet}
								<span class="font-medium">Secure Payment:</span> Your payment information is encrypted
			...
			<div class="mt-8 text-center">
				<p class="text-sm text-gray-600 dark:text-gray-400">
					Need help? Contact us at <a href="mailto:support@example.com" class="text-blue-600 hover:underline">support@example.com</a>
				</p>
			</div>
		</div>
	</div>
