<script lang="ts">
	...
	const ariaLabel = m['features.quickly-added-words.list.unconfirmed_badge']();
...
<Tooltip.Root>
	<Tooltip.Trigger
		type="button"
		id="qaw-unconfirmed-{itemId}"
		class="inline-flex shrink-0 cursor-default bg-transparent opacity-80 transition-opacity hover:opacity-100"
