...
import type { QuicklyAddedWordDTO } from '$quicklyAddedWords/types';
import {
...
describe('groupQawByWeek', () => {
	...
	describe('positive path', () => {
		it('should group items into weekly sections ordered newest first', () => {
		...
		it('should preserve item order within the same week', () => {
	...
	describe('negative path', () => {
		it('should skip items with invalid createdAt values', () => {
...
describe('formatQawWeekSectionLabel', () => {
	...
	describe('negative path', () => {
		it('should label older weeks with a date range', () => {
	...
	describe('edge cases', () => {
		it('should use custom this-week and last-week labels when provided', () => {
			const weekStart = startOfIsoWeekMonday(now);

			expect(
				formatQawWeekSectionLabel(weekStart, now, undefined, {
